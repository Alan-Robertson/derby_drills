\subsection*{Drill: Jammer Ping Pong}
\label{drill:reforming/ping_pong}
...
\includegraphics[scale=1]{img/ping_pong/position}
\end{minipage}


\subsection*{Variant: No Hitting Out}  
\label{drill:reforming/ping_pong/no_hitting_out}
...
\label{drill:reforming/ping_pong/dont_stop}


\begin{minipage}{0.38\textwidth}
\includegraphics[scale=1,trim={0 0 0 4cm}, clip]{img/ping_pong/dont_stop}
\end{minipage}
\hfill
\begin{minipage}{0.6\textwidth}
