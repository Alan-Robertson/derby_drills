...
\draw[black!70, rounded corners=0.5em, fill=black!55, rotate around={-\skateangle:(0, 0.5 * \platelength)}] (0.5 * \axlelength + 0.5 * \wheelwidth, 0.5 * \platelength + 0.5 * \wheelheight) rectangle (0.5 * \axlelength - 0.5 * \wheelwidth, 0.5 * \platelength - 0.5 * \wheelheight) ; 

\draw[black!60, rounded corners=0.5em, fill=black!45, rotate around={-\skateangle:(0, 0.5 * \platelength)}] (-0.5 * \axlelength + 0.5 * \wheelwidth, 0.5 * \platelength + 0.5 * \wheelheight) rectangle (-0.5 * \axlelength - 0.5 * \wheelwidth, 0.5 * \platelength - 0.5 * \wheelheight) ; 
